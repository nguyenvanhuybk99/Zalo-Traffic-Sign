...
# data_summary = open('data_summary_{}'.format(time_str), 'a')
...
class HUMAN(data.Dataset):
  ...
  def __init__(self, opt, split):
    ...
    self.annot_path = os.path.join(
        ...
        'human_{}.json').format(split)

    self.split = split
    self.opt = opt

    print('==> initializing human {} data.'.format(split))
    ...
    # data_summary.write('Loaded {} {} samples'.format(split, self.num_samples))
    # data_summary.close()
